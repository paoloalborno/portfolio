const translations = {
    ...
    "about": {
        ...
        "mission_p1": { "en": "I'm Paolo Alborno, a Software Engineer with solid experience in the world of cloud computing, particularly with AWS, and in backend development. My mission is to design and build the architecture behind the scenes, ensuring that applications are high-performing, scalable, and secure.", "it": "Sono Paolo Alborno, un Software Engineer con una solida esperienza nel mondo del cloud computing, in particolare con AWS, e nello sviluppo di backend. La mia missione è progettare e costruire l'architettura che sta dietro le quinte, garantendo che le applicazioni siano performanti, scalabili e sicure." },
        "mission_p2": { "en": "I hold AWS, Scrum, and Project Management certifications, which allow me to approach projects with a holistic view, combining technical expertise with effective management of the development process. I have worked on projects ranging from analyzing e-commerce infrastructures to developing Natural Language Processing (NLP) models with BERT, demonstrating versatility and strong problem-solving skills.", "it": "Possiedo certificazioni AWS, Scrum e di Project Management, che mi permettono di affrontare i progetti con una visione olistica, combinando competenza tecnica con una gestione efficace del processo di sviluppo. Ho lavorato su progetti che spaziano dall'analisi di infrastrutture per e-commerce allo sviluppo di modelli di Natural Language Processing (NLP) con BERT, dimostrando versatilità e una forte capacità di problem-solving." },
        "mission_p3": { "en": "I firmly believe in the power of technology to solve real-world problems and I am always looking for new challenges to refine my skills and contribute to innovative projects.", "it": "Credo fermamente nel potere della tecnologia per risolvere problemi reali e sono sempre alla ricerca di nuove sfide per affinare le mie competenze e contribuire a progetti innovativi." },
    ...
    "projects": {
        ...
        "python_h3": { "en": "Code Snippets in Python", "it": "Code Snippets in Python" },
        "python_p": { "en": "A collection of code snippets and small scripts I've written in Python for various purposes, from data analysis to simple utilities.", "it": "Una raccolta di snippet di codice e piccoli script che ho scritto in Python per vari scopi, dall'analisi dei dati a semplici utility." },
        "python_btn": { "en": "View Snippets", "it": "Vedi gli Snippet" },
